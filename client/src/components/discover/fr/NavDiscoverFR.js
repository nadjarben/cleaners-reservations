...
export default function NavDiscover() {
    ...
    return (
        ...
        <div className='nav-discover'>
            <Link to='/discoverfr/who'><h1 onClick={() => setTitle('QUI SOMMES NOUS')}>QUI SOMMES NOUS</h1></Link>
            <Link to='/discoverfr/engagements'><h1 onClick={() => setTitle('ENGAGEMENTS')}>ENGAGEMENTS</h1></Link>
            <Link to='/discoverfr/knowledge'><h1 onClick={() => setTitle('SAVOIR-FAIRE')}>SAVOIR-FAIRE</h1></Link>
